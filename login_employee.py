...
def employee():
    ...
    if (a == "" and b == ""):
        ...
        try:
            ...
            cursor_.execute("select * from employee_login where username = %s and password = %s",(a,b))
            ...
            if (data == None):
                ...
                root.destroy()
                call(["python" , "employee_dashboard.py"])
                connect_.close()
...
l2 = Label(root,text="Employee Login" ,font = "Tahoma 30" ,fg ="blue",
bg ="white").place(x=115,y=20)
...
,padx=50,borderwidth=2,command = employee , cursor = "hand2").place(x=45,y=310)
